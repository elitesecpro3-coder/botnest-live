...
(function () {
    ...
    function shortenBusinessName(name, maxLen) {
        ...
        if (!result)
            result = trimmed.slice(0, Math.max(1, maxLen - 1)) + '…';
        return result;
    }
    /**
     ...
     */
    function deriveLauncherText(config, ui) {
    ...
    function createWidget(config) {
      ...
      `;
            ...
            const headerDiv = chat.querySelector('#botnest-header');
            const poweredDiv = chat.querySelector('#botnest-powered');
